...
class AuthTemplate(application: play.api.Application) extends TemplatesPlugin{

	def getLoginPage[A](implicit request: Request[A], form: Form[(String, String)], msg: Option[String]): Html = views.html.authentication.signin(form, msg)

	def getNotAuthorizedPage[A](implicit request: Request[A]): Html = ???

	/* views only required for username/password authentication */
